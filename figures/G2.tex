...
\begin{document}
	\begin{center}
		\begin{tikzpicture}
			...
			\tikzstyle{Bell}=[shape=rectangle,rounded corners,thick,draw=black!50,thick,fill=black!20,minimum height=10mm,minimum width=10mm]

			\node[AB] (A-0) at (0,2) {\small $A_0$};
			\node[AB] (B-0) at (0,-2) {\small $B_0$};
			\node[AB] (sig) at (-2,0) {\small $\sigma$};
			
			\node[Bell] (Rand-0) at (2,4) {\includegraphics[scale=0.05]{dice.png}};
			\node[Bell] (Rand-1) at (2,-4) {\includegraphics[scale=0.05]{dice.png}};
			\node[AB] (A-1) at (4,4) {\small $A_1$};
			\node[AB] (B-1) at (4,-4) {\small $B_1$};		
			\node[Ref] (Ref-0) at (6,0) {\small $R_0$};
			\node[Bell] (Bell-0) at (8,2) {\large T};
			\node[Bell] (Bell-1) at (8,-2) {\large T};			
			\node[Bell] (Eq-0) at (10,2) {\large $\stackrel{?}{=}$};
			\node[Bell] (Eq-1) at (10,-2) {\large $\stackrel{?}{=}$};

			\node[Ref] (Ref-1) at (12,0) {\small $R_1$};

			\draw[-,thick] (-2,2) to node[above]{$\reg{A}$} (-0.5,2);
			\draw[-,thick] (-2,-2) to node[above]{$\reg{B}$} (-0.5,-2);
			
			\draw[-,thick] (0,2.5) to (0,5);
			\draw[-,thick] (0,-2.5) to (0,-5);
			
			\draw[-,thick] (-2,0.5) to (-2,2); 
			\draw[-,thick] (-2,-0.5) to (-2,-2);
			
			\draw[-,thick] (0,5) to node[above]{$\reg{C}$} (4,5);
			\draw[-,thick] (0,-5) to node[above]{$\reg{D}$} (4,-5);
			
			\draw[-,thick] (4,5) to (4,4.5);
			\draw[-,thick] (4,-5) to (4,-4.5);

			\draw[double,thick] (Rand-0) to node[above]{$x$}  (A-1);
			\draw[double,thick] (Rand-1) to node[above]{$y$}  (B-1);
			
			\draw[-,thick] (A-0) to node[above]{$\reg{X}_1$} (Bell-0);
			\draw[-,thick] (B-0) to node[above]{$\reg{Y}_1$} (Bell-1);
			
			\draw[double,thick] (Bell-0) to node[above]{$x_2$} (Eq-0);
			\draw[double,thick] (Bell-1) to node[above]{$y_2$} (Eq-1);
		
			\draw[-,thick] (6.5,0.5) [out=90,in=180] to [out=0,in=180] node[above] {$\reg{X} \ $} (7.5,1.8);
			\draw[-,thick] (6.5,-0.5) [out=90,in=180] to [out=0,in=180] node[above] {$\reg{\ Y}$} (7.5,-1.8);	
			\draw[-,thick] (Ref-0) to node[above]{$\reg{R}$} (Ref-1);
			
			\draw[double,thick] (10.5,1.8) [out=90,in=180] to [out=0,in=180] node[above] {$ \quad \ \ \ \delta_{x_1,x_2}$} (11.5,0.5);
			\draw[double,thick] (10.5,-1.8) [out=90,in=180] to [out=0,in=180] node[above] {$\delta_{y_1,y_2} \quad \ \ \ $} (11.5,-0.5);	
			
			\draw[double,thick] (2,3.5) to (2,3);
			\draw[double,thick] (2,3) to node[above]{$x_1$}	(10,3); 
			\draw[double,thick] (10,3) to (10,2.5);		
			
			\draw[double,thick] (2,-3.5) to (2,-3);
			\draw[double,thick] (2,-3) to node[above]{$y_1$}	(10,-3); 		
			\draw[double,thick] (10,-3) to (10,-2.5);		
			
			\draw[double,thick] (A-1) to node[above]{$a$} (12,4);
			\draw[double,thick] (B-1) to node[above]{$b$} (12,-4);
			\draw[double,thick] (12,4) to (12,0.7);
			\draw[double,thick] (12,-4) to (12,-0.7);

			\draw[double,thick] (Ref-1) to (13.5,0);			
			
			\draw [dashed] (5.5,-4.5) -- (5.5,4.5);
